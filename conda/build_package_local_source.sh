...
micromamba create --quiet -p ./build/env python==3.11 python-build rattler-build conda-build
...
rattler-build build --recipe meta_local_source.yaml --output-dir=build/conda_package
