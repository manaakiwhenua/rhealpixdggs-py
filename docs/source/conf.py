...
latex_documents = [
  ('index', 'rHEALPixDGGS.tex', 'rHEALPixDGGS Documentation',
...
man_pages = [
    ('index', 'rHEALPixDGGS', 'rHEALPixDGGS Documentation',
     ['Alexander Raichev'], 1)
]
...
texinfo_documents = [
  ('index', 'rHEALPixDGGS', 'rHEALPixDGGS Documentation',
   'Alexander Raichev', 'rHEALPixDGGS', 'One line description of project.',
   'Miscellaneous'),
]
