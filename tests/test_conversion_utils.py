...
# test geom from https://gds.loci.cat/geometry/geofabric2_1_1_contractedcatchment/12104622?_format=text/turtle&_view
# =geometryview
...
class ConversionUtilsTestCase(unittest.TestCase):
    ...
    def test_CellZoneFromPoly(self):
        ...
        or compression.
        """
        ground_truth_cells_list_for_catchment_12104622_at_res_9 = ['R785183285', 'R785183287', 'R785183288',
        ...
        cell_str_list = [str(cell) for cell in cells_obj_list]
        for cell_str in cell_str_list:
            assert cell_str in ground_truth_cells_list_for_catchment_12104622_at_res_9
