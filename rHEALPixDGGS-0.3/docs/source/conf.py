# -*- coding: utf-8 -*-
#
# scenzgrid-dggs documentation build configuration file, created by
...
htmlhelp_basename = 'scenzgrid-dggsdoc'
...
latex_documents = [
  ('index', 'scenzgrid-dggs.tex', u'scenzgrid-dggs Documentation',
...
man_pages = [
    ('index', 'scenzgrid-dggs', u'scenzgrid-dggs Documentation',
...
texinfo_documents = [
  ('index', 'scenzgrid-dggs', u'scenzgrid-dggs Documentation',
   u'Alexander Raichev', 'scenzgrid-dggs', 'One line description of project.',
   'Miscellaneous'),
]
