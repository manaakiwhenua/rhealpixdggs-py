r"""
This Python 2.7 code tests the ``dggs_rhealpix`` module.
...
from ellipsoids import WGS84_ASPHERE_RADIANS, Ellipsoid
...
WGS84_123 = RHEALPixDGGS(ellipsoid=WGS84_ELLIPSOID, 
                         north_square=1, south_square=2, N_side=3)
WGS84_123_RADIANS = RHEALPixDGGS(ellipsoid=WGS84_ELLIPSOID_RADIANS, 
                                 north_square=1, south_square=2, N_side=3)
