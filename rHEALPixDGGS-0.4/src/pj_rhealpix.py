r"""
This Python 2.7 module implements the rHEALPix map projection.
...
from projection_tools import auth_rad
...
def combine_triangles(x, y, north_square=0, south_square=0, inverse=False):
    ...
    EXAMPLES::
        ...
        >>> u, v = -pi/4, pi/3
        >>> x, y = combine_triangles(u, v); x, y
        (-1.8325957145940459, 1.5707963267948966)
        >>> combine_triangles(x, y, inverse=True); u, v
