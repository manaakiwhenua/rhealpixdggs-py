r"""
This Python 2.7 module implements the icosohedral Snyder equal area map projection (ISEA) for ellipsoids of revolution by using the spherical version of the projection (from the PROJ.4 library) on the ellipsoid's authalic sphere.
...
import pyproj
from numpy import rad2deg, deg2rad, array
# Import my modules.
