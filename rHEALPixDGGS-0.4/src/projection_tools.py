r"""
This Python 2.7 module implements several helper functions for coding map projections.
...
def auth_rad(a, e, inverse=False):
    ...
    EXAMPLES::
        ...
        0.25 0.98939325967
        0.111111111111 0.99793514743
        0.0625 0.999348236456
        0.04 0.999733212354
        0.0277777777778 0.999871371052
        0.0204081632653 0.999930576286
        0.015625 0.999959307081
        0.0123456790123 0.999974596271
        0.01 0.999983332861
    """
    if e == 0:
        return a
